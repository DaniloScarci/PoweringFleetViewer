...
export const PlateFilter = styled.input`
...
export const VehiclesListItemContainer = styled.div`
  display: flex;
  flex-direction: column;
  gap: 5px;
  min-height: 430px;
...
export const NewVehicleInfoContainer = styled.div`
    width: 80%
    margin: 0 auto;
    display: flex;
    flex-direction: column;
...
export const VehicleViewInfoContainer = styled.div`
  display: flex;
  flex-direction: row;
  gap: 10px;
  align-items: center;
...
export const VehicleViewInfoTitle = styled.div`
  font-family: "Sue Ellen Francisco", cursive;
`;

export const VehicleViewInfoValue = styled.div``;
